...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Score.shit'
        db.add_column(u'snake_score', 'shit',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'Score.when'
        db.add_column(u'snake_score', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Score.shit'
        db.delete_column(u'snake_score', 'shit')

        # Deleting field 'Score.when'
        db.delete_column(u'snake_score', 'when')
    ...
    models = {
        ...
        u'snake.score': {
            ...
            'shit': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
